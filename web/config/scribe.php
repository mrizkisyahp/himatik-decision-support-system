...
return [
    ...
    'description' => 'REST API for the HIMATIK Recruitment Decision Support System (DSS). Used by the Flutter mobile app to manage candidate registration, interview scheduling, evaluation scoring, and announcement publishing.',
    ...
    'auth' => [
        ...
        'extra_info' => 'Authenticate via <b>POST /api/login</b> to receive a Sanctum Bearer token. Pass it as <code>Authorization: Bearer {token}</code> on all protected endpoints.',
    ],
