    ...
    @php
        $navGroups = [
            [
                'label' => null,
                'items' => [
                    ['label' => 'Jadwal Interview', 'route' => 'interviewer.schedule'],
    ...
    <div class="min-h-screen lg:flex">
        <aside data-admin-sidebar class="fixed inset-y-0 left-0 z-40 w-72 -translate-x-full border-r border-[#dce5f8] bg-white shadow-2xl shadow-[#223872]/10 transition lg:static lg:translate-x-0 lg:shadow-none">
            <div class="flex h-full flex-col">
                <div class="flex items-center justify-between border-b border-[#dce5f8] px-6 py-6">
                    <div>
                        <a href="{{ route('interviewer.schedule') }}" class="text-xl font-black tracking-tight text-[#223872]">HIMATIK<span class="text-[#4A90E2]">.</span></a>
                        <p class="text-xs font-bold text-[#64748b]">Interviewer Portal</p>
                    </div>
