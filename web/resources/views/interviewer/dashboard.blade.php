...
<head>
    ...
    <title>Interviewer Dashboard — HIMATIK DSS</title>
...
<body class="min-h-screen flex flex-col items-center justify-center bg-[#fafaf9] font-sans antialiased">
    ...
    <div class="text-center px-6 py-10 max-w-[640px] flex flex-col items-center">
        ...
        <code class="text-[0.78rem] text-stone-400 bg-stone-100 px-3 py-1.5 rounded-md border border-stone-200 font-mono">
            resources/views/interviewer/dashboard.blade.php
        </code>
        ...
        <p class="text-base text-stone-500 leading-relaxed mb-8">
            Shows all interview slots assigned to the logged-in interviewer with candidate details.
        </p>
        ...
        <a href="{{ route('docs.blade') }}#interviewer-dashboard" class="inline-flex items-center gap-2 bg-amber-500 text-stone-900 px-6 py-3 rounded-xl font-bold text-[0.9rem] hover:bg-amber-600 transition-all">
            📖 View Documentation →
        </a>
    </div>
