...
<head>
    ...
    <title>Landing Page - HIMATIK DSS</title>
...
<body class="min-h-screen flex flex-col items-center justify-center bg-[#fafaf9] font-sans antialiased">
    ...
    <div class="text-center px-6 py-10 max-w-[640px] flex flex-col items-center">
        ...
        <p class="text-base text-stone-500 leading-relaxed mb-8">
            Public landing page and post-OTP destination before the candidate starts the full registration profile.
        </p>
        ...
        <div class="flex gap-2 justify-center flex-wrap mb-10">
            ...
            <span class="bg-slate-50 text-slate-500 border border-slate-200 px-3 py-1 rounded-full text-[0.75rem] font-semibold">
                public
            </span>
        </div>

        <a href="{{ route('docs.blade') }}#landing" class="inline-flex items-center gap-2 bg-amber-500 text-stone-900 px-6 py-3 rounded-xl font-bold text-[0.9rem] hover:bg-amber-600 transition-all">
            View Documentation ->
        </a>
    </div>
</body>
