...
<body class="min-h-screen flex flex-col items-center justify-center bg-[#fafaf9] font-sans antialiased">
    ...
    <div class="text-center px-6 py-10 max-w-[640px] flex flex-col items-center">
        ...
        <p class="text-base text-stone-500 leading-relaxed mb-8">
            Login form for all roles: candidate, interviewer, and admin.
        </p>
        ...
        <a href="{{ route('docs.blade') }}#login" class="inline-flex items-center gap-2 bg-amber-500 text-stone-900 px-6 py-3 rounded-xl font-bold text-[0.9rem] hover:bg-amber-600 transition-all">
            📖 View Documentation →
        </a>
    </div>
